...
export default function ButtonStyle({ fetchRecipe, name }) {

    return (
        <div>
            <a onClick={fetchRecipe} className="btn btn--svg js-animated-button" href="#project"><span className="btn--svg__label">{name}</span>
