...
export default function ButtonStyle({ fetchRecipe }) {

    return (
        <div>
            <a onClick={fetchRecipe} className="btn btn--svg js-animated-button" href="#project"><span className="btn--svg__label">Предложить рацион</span>
